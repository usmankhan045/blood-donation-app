...
class RecipientSignUpScreen extends StatefulWidget {
  const RecipientSignUpScreen({Key? key}) : super(key: key);

  @override
  _RecipientSignUpScreenState createState() => _RecipientSignUpScreenState();
}
...
class _RecipientSignUpScreenState extends State<RecipientSignUpScreen> {
  ...
  Future<void> _signUpRecipient() async {
    setState(() {
      _loading = true;
      _error = null;
    });
            ...
            actions: [
              TextButton(
                onPressed: () {
                  ...
                  Navigator.pushReplacementNamed(context, '/recipient_login');
                },
                child: Text('OK'),
              ),
            ],
  ...
  Future<void> _signInWithGoogle() async {
    ...
    try {
      ...
      // If not exists, create recipient doc
      if (!userSnapshot.exists) {
        ...
        setState(() {
          _error = 'Not a recipient account.';
        });
        return;
      }
  ...
  Widget build(BuildContext context) {
    ...
    const loginLink = Color(0xFFD7263D);
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                'Find donors easily, fast, and nearby.',
              ...
              Center(
                child: GestureDetector(
                  onTap: () {
                    Navigator.pushNamed(context, '/recipient_login');
                  },
                  child: RichText(
                    text: TextSpan(
