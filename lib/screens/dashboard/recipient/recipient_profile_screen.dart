...
class _RecipientProfileScreenState extends State<RecipientProfileScreen> {
  ...
  // Dynamic "Other fields" editors (string-only)
  ...
  // Keys we consider "known" (won't show in 'Other fields')
    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snap) {
          ...
          _hydrateFromSnapshot(data, editing: _editing); // no setState here

          final role = (data['role'] ?? '').toString();
          final verified = (data['verified'] ?? false) as bool;
          final profileCompleted = (data['profileCompleted'] ?? false) as bool;
                ...
                children: [
                              ...
                              child: DropdownButtonFormField<String>(
                                ...
                                items: _genders
                                  ...
                                  child: Text(
                                    ...
                                    .toList(),
                                // Make the selected (closed) view ellipsize too
                        ...
                        DropdownButtonFormField<String>(
                          ...
                          items: _bloodTypes
                            ...
                            child: Text(
                              ...
                              .toList(),
                          selectedItemBuilder: (context) => _bloodTypes
                              .map((b) => Align(
                            alignment: Alignment.centerLeft,
                            child: Text(
                              b,
                    ...
                    child: Column(
                      children: [
                        _textField(
                          ...
                          validator: (v) =>
                          (v == null || v.trim().length < 8) ? 'Enter a valid number' : null,
                        ),
                        const SizedBox(height: 12),
                        _textField(
                          label: 'City',
                  ...
                  _sectionCard(
                    ...
                    child: Column(
                      ...
                      children: [
                        _readOnlyLine('Email', userEmail),
                        const SizedBox(height: 8),
                        _readOnlyLine('Role', role.isEmpty ? 'Recipient' : role),
                        const SizedBox(height: 8),
                        _readOnlyLine('Verified', verified ? 'Yes' : 'No'),
                        const SizedBox(height: 8),
                        if (createdAt is Timestamp)
                          _readOnlyLine('Created',
                              createdAt.toDate().toString().split('.').first),
                        if (updatedAt is Timestamp)
                          _readOnlyLine('Updated',
                  ...
                  // OTHER FIELDS (dynamic, string-only editors)
                  _sectionCard(
                    title: 'Other Fields',
                    trailing: _editing
                        ? IconButton(
  ...
  void _hydrateFromSnapshot(Map<String, dynamic> data, {required bool editing}) {
    if (editing) return;
    ...
    for (final entry in data.entries) {
      ...
      if (val is String) {
        _otherCtrs[key] = TextEditingController(text: val);
      }
    }
  }
  ...
  Future<void> _addCustomFieldDialog() async {
      ...
      builder: (_) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const Text(
              'Note: only string values are supported here.',
    ...
    if (key.isNotEmpty && !reserved.contains(key)) {
      setState(() {
        _otherCtrs[key] = TextEditingController(text: value);
      });
    }
  }
  ...
  Future<void> _save() async {
    ...
    try {
      final updates = <String, dynamic>{
        ...
        // Basic completion rule: name+phone+city+bloodType present
                ...
                Wrap(
                  ...
                  children: [
                    _chip(
                      ...
                      Colors.white,
                      textColor:
                      completed ? const Color(0xFF2C8D7C) : Colors.black87,
                    ),
                    _chip(
                      verified ? 'Verified' : 'Unverified',
                      Colors.white,
                      textColor: verified
                          ? const Color(0xFF2C8D7C)
                          : Colors.orange.shade800,
                    ),
                    _chip(
                      role.isEmpty ? 'Recipient' : role,
                      Colors.white,
