    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            // Profile Completion Banner or Status
            Card(
                        ...
                        children: [
                          ...
                          if (!profileCompleted!)
                            ElevatedButton.icon(
                              ...
                              onPressed: () async {
                                final updated = await Navigator.pushNamed(context, '/hospital_profile_completion');
                                fetchProfileStatus();
                              },
                            ),
                        ],
            ...
            // Main features grid (restrict features if not complete)
            Expanded(
              child: GridView.count(
                ...
                children: [
                  ...
                  _buildFeatureTile(
                    ...
                    onTap: () {
                      Navigator.pushNamed(context, '/hospital_profile_completion')
